...
def generate_hi_rules(theme):
    ...
    hi_rules.append(f"set background={theme.theme_background}\n")
    hi_rules.append(f'let g:colors_name="{theme.scheme_name}"\n')
    hi_rules.append("\n")
    ...
    theme.hi_rules = hi_rules

    hi_rules = []
    terminal_colors = 0

def clear_hi_rules(theme):
    """Clear the theme rules
    """
    theme.hi_rules.clear()
